...
typedef enum
{
    ...
    /*  Предупреждение библиотеки NanoLib */
    INF_ENGINE_WARN_SYNONYM_DUPLICATE = 103, /** Неоднозначное определение синонимов. */
    ...
    INF_ENGINE_WARN_SYMBOLYM_DUPLICATE = 107, /** Неоднозначное определение заменяемых символов. */
