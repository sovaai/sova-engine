...
inline void * operator new( size_t size, nMemoryAllocator & allocator ) noexcept
{
...
inline void operator delete( void * /*ptr*/, nMemoryAllocator & /*allocator*/ ) noexcept {}
...
#define nAllocateObjects( aAllocator, aClass, aNumber ) static_cast<aClass*>( (aAllocator).Allocate( sizeof( aClass ) * aNumber ))

#define nAllocateNewObjects( aAllocator, aClass, aNumber, aName ) aClass * aName = static_cast<aClass*>( (aAllocator).Allocate( sizeof( aClass ) * aNumber ))
