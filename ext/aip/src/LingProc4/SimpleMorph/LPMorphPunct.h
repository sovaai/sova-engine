 ...
 * @date   Tue Apr  8 04:05:53 2008
 * 
 * @brief  Punctuation morphology for LingProc.
 * 
 * 
 */
#ifndef _LPMORPHPUNCT_H_
#define _LPMORPHPUNCT_H_

#include "LPMorphInterface.h"
#include "../WordNormalizerInterface.h"

/* The punctuation morphology */
class LPMorphPunct : public LPMorphInterface
{
public:
    /** 
     ...
     * 
     */
    LPMorphPunct() : LPMorphInterface(), normalizer( 0 ), _size( 0 ) { }
    /** 
...
private:
    LingProcErrors processWord( uint32_t     &ch,
                                const char   *word,
                                size_t        wordLength = (size_t)(-1) );
