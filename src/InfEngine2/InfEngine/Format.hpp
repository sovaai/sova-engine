...
#define BY_TABLE( aPtr, aShiftToTable, aNum, aType ) \
    ( aPtr ? BY_POS( aPtr, BY_SHIFT( aPtr, aShiftToTable, const uint32_t* )[aNum], const char * ) : 0 )
...
// Элемент, который всегда находится на в плоском массиве по одному и тому же смещению.
...
#define HEADER_FIELDS_1( aName1, aType1, aSize1 ) \
    HEADER_FIELDS_0\
    FIELD1( aName1, aType1, aSize1 )


#define HEADER_FIELDS_2( aName1, aType1, aSize1, aName2, aType2, aSize2 ) \
    HEADER_FIELDS_1( aName1, aType1, aSize1 )\
    FIELD2( aName2, aType2, aSize2 )


#define HEADER_FIELDS_3( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3 ) \
    HEADER_FIELDS_2( aName1, aType1, aSize1, aName2, aType2, aSize2 ) \
    FIELD3( aName3, aType3, aSize3 )


#define HEADER_FIELDS_4( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3, \
                         aName4, aType4, aSize4 ) \
    HEADER_FIELDS_3( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3 ) \
    FIELD4( aName4, aType4, aSize4 )


#define HEADER_FIELDS_5( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3, \
                         aName4, aType4, aSize4, aName5, aType5, aSize5 ) \
    HEADER_FIELDS_4( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3, \
                     aName4, aType4, aSize4 ) \
    FIELD5( aName5, aType5, aSize5 )


#define HEADER_FIELDS_6( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3, \
                         aName4, aType4, aSize4, aName5, aType5, aSize5, aName6, aType6, aSize6 ) \
    HEADER_FIELDS_5( aName1, aType1, aSize1, aName2, aType2, aSize2, aName3, aType3, aSize3, \
                     aName4, aType4, aSize4, aName5, aType5, aSize5 ) \
    FIELD6( aName6, aType6, aSize6 )
