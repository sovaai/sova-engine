...
const DLFucntionArgInfo IsEqual::ARGS[] = {
    { DLFAT_EXTENDED, 0},
    { DLFAT_EXTENDED, 0}
};

const DLFunctionInfo IsEqual::DLF_INFO = {
    "IsEqual",
    "=",
...
ExtICoreRO * IsEqual::vBase = nullptr;
...
InfEngineErrors IsEqual::Apply(const char ** aArgs,
        const char *& aResult,
