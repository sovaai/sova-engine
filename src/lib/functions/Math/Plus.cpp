...
static const DLFunctionInfo DLF_INFO = {
	"Plus",
	"m+",
	"Returns result of addition of two integers.",
	DLFRT_TEXT,
	3,
	ARGS,
	{ 3, 1, 0 },
...
InfEngineErrors Plus( const char ** aArgs, const char *& aResult, unsigned int & aLength,
...
CREATE_TEST2( TEST_00, "2000000446912", 2, "1000000223456", "1000000223456" )
CREATE_TEST2( TEST_01, "-2446912", 2, "-1223456", "-1223456" )
...
CREATE_TEST2( TEST_07, "246913", 2, "123457", "123456" )
CREATE_TEST2( TEST_08, "-122222", 2, "1234", "-123456" )

CREATE_TEST2( TEST_09, "346912.7", 2, "123456.5", "223456.2" )
CREATE_TEST2( TEST_10, "0", 2, "-123456", "123456" )
CREATE_TEST2( TEST_11, "-5", 2, "-3", "-2" )
CREATE_TEST2( TEST_12, "-5246912", 2, "-2123456", "-3123456" )
CREATE_TEST2( TEST_13, "-5", 2, "-2", "-3" )
CREATE_TEST2( TEST_14, "-111324", 2, "-000", "-111324" )

CREATE_TEST2( TEST_15, "-2877884", 2, "369488", "-3247372" )
CREATE_TEST2( TEST_16, "-1", 2, "-369488369", "369488368" )
CREATE_TEST2( TEST_17, "100", 2, "369488469", "-369488369" )

CREATE_TEST2( TEST_18, "-2877884", 2, "369488", "минус три миллиона двести сорок семь тысяч триста семьдесят два" )
CREATE_TEST2( TEST_19, "-1", 2, "-369488369", "триста шестьдесят девять миллионов четыреста восемьдесят восемь тысяч триста шестьдесят восемь" )
CREATE_TEST2( TEST_20, "сто", 3, "369488469", "-369488369", "RU" )
CREATE_TEST2( TEST_21, "123.456", 2, "100.006", "23.45" )
...
DEFAULT_CHECK_DL_FUNCTION( Plus )
